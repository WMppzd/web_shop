			...
			<div style="margin: 0 auto; width: 950px;">
				<div class="col-md-6">
					<img style="opacity: 1; width: 400px; height: 350px;" title=""
						class="medium"
						src="${pageContext.request.contextPath }/${info.pimage}">
				</div>

				<div class="col-md-6">
					<div>
						<strong>${info.pname}</strong>
					</div>
					<div
					...
					<div style="margin: 10px 0 10px 0;">
						亿家价: <strong style="color: #ef0101;">￥：${info.shop_price}元/份</strong> 参 考 价：
						<del>￥${info.market_price}元/份</del>
					</div>
					...
					<div
						...
						<div><a href="${pageContext.request.contextPath}/getProByCid?cid=${cid}&currentPage=${currentPage}">返回列表</a></div>
					</div>
				</div>
			</div>
			<div class="clear"></div>
